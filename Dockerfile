...
ENV DEBIAN_FRONTEND=noninteractive \
    ...
    PATH=/usr/local/cuda/bin:/root/.local/bin:/workspace/RoboDojo/.venv/bin:${PATH} \
...
# ── Optional China mirror (build args; defaults = official upstreams) ─────────
